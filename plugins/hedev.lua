...
✵•┈••●◆💈◆●••┈•✵
- DEV -  @ahmadnamed  📌
- Channel - @ahmadnameddd ]] end if not is_momod(msg) then return "للمطورين فقط ⛔️😴✋🏿️🏿️" end end return { description = "Help list", usage = "sudo list", patterns = { "[#!/](hedev)" }, run = run } end 
